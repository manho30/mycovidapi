    ...
    $str = <<<EOD
{
    ...
    "data":{
        ...
        "datasets":[
            {
                "data":[12,6,5,18,12,20,50,80,90,78,24,67],
                "fill":false,
                "borderColor":getGradientFillHelper("vertical",["#fafa6e","#ecf76f","#dff470","#d2f072","#c5ed74","#b9e976","#ace578","#a0e17b","#95dd7d","#89d880","#7ed482","#73cf84","#68ca87","#5dc589","#52c18a","#48bc8c","#3eb78d"]),
                "borderWidth":3,
                "pointRadius":0,
